...
class SXSDataLoader:
    ...
    def load_grid_structure(self):
        ...
        self.r_min, self.r_max = GetSphereRadialExtents(radii_dict, sub_domain=self.subdomain)
    ...
    def get_four_metric(self, t_step=0, component='tt'):
        ...
        reqd_data = dat_file['psi'][t_key][component][...].reshape(self.n_phi, self.n_theta, self.n_radii).T
        dat_file.close()
